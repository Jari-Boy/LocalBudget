...
| CSVインポート | 金融機関CSVの中間表現への正規化、データ駆動のマッピング定義(`import_mapping_definitions`)、パースからレビュー確定までのフロー、Reader/マッピング定義/レビュー画面/Repositoryの責務分担。**たたき台** | [domain/csv-import.md](./domain/csv-import.md) |
